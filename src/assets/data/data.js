...
import lashbarScreen from "../images/portfolio_lash_bar_1_.webp";
import lashbarScreenMinor from "../images/portfolio_lash_bar_1_.png";
...
import progamingScreen from "../images/portfolio_pro-gaming_1_screen_1.webp";
import progamingScreenMinor from "../images/portfolio_pro-gaming_1_screen.png";
...
import prodentalScreen from "../images/portfolio_prodental_1_screen.webp";
import prodentalScreenMinor from "../images/portfolio_prodental_1_screen.png";
...
import carpathiaScreen from "../images/portfolio_carpathia_1_screen.webp";
import carpathiaScreenMinor from "../images/portfolio_carpathia_1_screen.png";
...
import booksBSScreenMinor from "../images/portfolio_books_bs_app_1_screen.png";
import booksBSScreen from "../images/portfolio_books_bs_app_1_screen.webp";
...
import photoScreenMinor from "../images/portfolio_photo_1_screen.png";
import photoScreen from "../images/portfolio_photo_1_screen.webp";
...
import bookDataMinerScreenMinor from "../images/portfolio_book_data_miner_app_1_screen.png";
import bookDataMinerScreen from "../images/portfolio_book_data_miner_app_1_screen.webp";
import bookDataMinerImg from "../images/portfolio_book_data_miner_app_1.jpg";
import bookDataMinerImgAddFirst from "../images/portfolio_book_data_miner_app_2.jpg";
import bookDataMinerImgAddSecond from "../images/portfolio_book_data_miner_app_3.jpg";
import bookDataMinerIcon from "../icons/database-solid.svg";
...
export const detailsArr = [
  ...
  { id: 3, detailDesc: "Phone", detailValue: "+1(368)299-3665" },
...
export const portfolioDataArr = [
  {
    ...
    imageMinor: carpathiaScreenMinor,
  ...
  },
  {
    ...
    imageMinor: prodentalScreenMinor,
  ...
  },
  {
    ...
    imageMinor: progamingScreenMinor,
  ...
  {
    id: 6,
    image: bookDataMinerScreen,
    imageMinor: bookDataMinerScreenMinor,
    addImage: [
      bookDataMinerImg,
      bookDataMinerImgAddFirst,
      bookDataMinerImgAddSecond,
    ],
    icon: bookDataMinerIcon,
    techIcons: [
      { id: 1, icon: <SiHtml5 />, title: "HTML" },
      { id: 2, icon: <SiCss3 />, title: "CSS" },
      { id: 3, icon: <SiJavascript />, title: "Javascript" },
      { id: 4, icon: <SiNodedotjs />, title: "Node.js" },
      { id: 5, icon: <SiExpress />, title: "Express" },
      { id: 6, icon: <SiPuppeteer />, title: "Puppeteer" },
      { id: 7, icon: <SiFirebase />, title: "Google Firebase" },
    ],
    name: "Book Data Miner App",
    desc: "This app simplifies data gathering (data mining), with multiple user-friendly settings for your comfort. It gets data from top e-commerce sites and the web using just an ISBN code, converts and stores images, and checks prices. You have the flexibility to fine-tune your data and download it as an Excel file. It's your all-in-one data tool for smarter decisions.",
  },
];
